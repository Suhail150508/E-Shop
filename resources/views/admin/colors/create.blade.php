            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="{{ __('e.g. Red, Blue, Navy') }}" required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color" id="code_picker" value="{{ old('code', '#000000') }}" title="{{ __('Choose your color') }}">
                            <input type="text" class="form-control form-control-lg @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="{{ __('e.g. #FF0000') }}" required>
                        </div>
