...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    <div>
        <h2 class="h4 fw-bold mb-1">{{ __('Units') }}</h2>
        <p class="text-muted mb-0">{{ __('Manage your product units.') }}</p>
    </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-12 col-md-9">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control border-0 bg-light rounded-start-3 py-2 fs-14" placeholder="{{ __('Search units...') }}" value="{{ request('search') }}">
                ...
                <tbody>
                    @forelse($units as $unit)
                        <tr>
                            ...
                            <td>
                                <h6 class="mb-0 fw-bold text-dark">{{ $unit->name }}</h6>
                            </td>
