...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h4 fw-bold mb-1">{{ __('Edit Brand') }}</h2>
        <p class="text-muted mb-0">{{ __('Update brand details.') }}</p>
    </div>
    <a href="{{ route('admin.brands.index') }}" class="btn btn-secondary-soft">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $brand->name) }}" required>
                        @error('name')
                ...
                <div class="col-lg-4">
                    <div class="card border border-dashed text-center h-100 bg-light">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            ...
                            @if($brand->image_url)
                                <div class="mb-3">
                                    <img src="{{ $brand->image_url }}" alt="{{ $brand->name }}" class="img-fluid rounded border" style="max-height: 150px;">
                                </div>
                            @else
                                <div class="mb-3">
