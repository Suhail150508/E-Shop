...
@section('content')
@include('frontend.partials.breadcrumb', ['title' => $page->title ?? 'Available Coupons', 'bgImage' => $page->image ?? 'https://images.unsplash.com/photo-1607083206968-13611e3d76db?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80'])
