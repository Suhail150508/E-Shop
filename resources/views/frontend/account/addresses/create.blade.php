...
@section('title', __('common.add_new_address'))
...
@section('account_content')
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header bg-white border-bottom-0 py-3 px-4">
            <h5 class="mb-0 fw-bold">{{ __('common.address_create') }}</h5>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="type" name="type" class="form-select @error('type') is-invalid @enderror">
                            <option value="Home" @selected(old('type') === 'Home')>{{ __('common.home') }}</option>
                            <option value="Office" @selected(old('type') === 'Office')>{{ __('common.office') }}</option>
                            <option value="Other" @selected(old('type') === 'Other')>{{ __('common.other') }}</option>
                        </select>
                        @error('type')
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="line1" name="line1" value="{{ old('line1') }}" class="form-control border-start-0 ps-0 @error('line1') is-invalid @enderror" placeholder="{{ __('common.enter_address') }}" required>
                        </div>
                        @error('line1')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="label" name="label" value="{{ old('label') }}" class="form-control @error('label') is-invalid @enderror" placeholder="{{ __('common.enter_title') }}">
                        @error('label')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('common.enter_email') }}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="road" name="road" value="{{ old('road') }}" class="form-control @error('road') is-invalid @enderror" placeholder="{{ __('common.enter_road') }}">
                        @error('road')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" id="house" name="house" value="{{ old('house') }}" class="form-control @error('house') is-invalid @enderror" placeholder="{{ __('common.enter_house') }}">
                        @error('house')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="floor" name="floor" value="{{ old('floor') }}" class="form-control @error('floor') is-invalid @enderror" placeholder="{{ __('common.enter_floor') }}">
                        @error('floor')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code') }}" class="form-control @error('postal_code') is-invalid @enderror" placeholder="{{ __('common.enter_postal_code') }}">
                        @error('postal_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
