                    ...
                    <div class="card border-0 shadow-sm rounded-3 h-100">
                        <div class="card-body p-4">
                            ...
                            <div class="text-muted small mb-0">
                                ...
                                @endif
                                <div class="d-flex mb-1"><i class="fa-solid fa-city me-2 mt-1 opacity-50 address-icon-width"></i> <span>{{ trim(implode(', ', array_filter([$address->city, $address->state, $address->postal_code]))) ?: __('common.na') }}</span></div>
                                <div class="d-flex mb-1"><i class="fa-solid fa-globe me-2 mt-1 opacity-50 address-icon-width"></i> <span>{{ $address->country ?? __('common.na') }}</span></div>
                                @if($address->phone)
