...
use App\Http\Controllers\Admin\RefundReasonController;
...
Route::post('/virtual-try', [TryOnController::class, 'try'])->name('virtual.try');
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('email-configuration/templates', [EmailConfigurationController::class, 'templates'])->name('email-configuration.templates');
        Route::get('email-configuration/templates/{id}/edit', [EmailConfigurationController::class, 'editTemplate'])->name('email-configuration.templates.edit');
        Route::put('email-configuration/templates/{id}', [EmailConfigurationController::class, 'updateTemplate'])->name('email-configuration.templates.update');

        // Payment Methods
        Route::get('payment-methods', [PaymentMethodController::class, 'index'])->name('payment-methods.index');
        Route::put('payment-methods/{gateway}', [PaymentMethodController::class, 'update'])->name('payment-methods.update');
        ...
        Route::get('refund-requests', [AdminRefundController::class, 'index'])->name('refund-requests.index');
        Route::get('refund-requests/{refund}', [AdminRefundController::class, 'show'])->name('refund-requests.show');
        Route::put('refund-requests/{refund}', [AdminRefundController::class, 'update'])->name('refund-requests.update');
        ...
        Route::resource('support-departments', SupportDepartmentController::class);
        ...
        Route::post('menus/{menu}/items', [MenuController::class, 'addItem'])->name('menus.item.add');
        Route::put('menus/items/{item}', [MenuController::class, 'updateItem'])->name('menus.item.update');
        Route::delete('menus/items/{item}', [MenuController::class, 'deleteItem'])->name('menus.item.delete');
        Route::post('menus/sort', [MenuController::class, 'sortItems'])->name('menus.sort');
        ...
        Route::get('website-setup', [WebsiteSetupController::class, 'index'])->name('website-setup.index');
        Route::post('website-setup', [WebsiteSetupController::class, 'update'])->name('website-setup.update');
...
Route::middleware(['auth', 'role:customer'])->group(function () {
    ...
    // Support Ticket Routes
    Route::resource('support-tickets', FrontendSupportTicketController::class)
        ->only(['index', 'store', 'show'])
        ->names('customer.support-tickets');
    Route::post('support-tickets/{ticket}/reply', [FrontendSupportTicketController::class, 'reply'])
...
Route::prefix('staff')
    ...
    ->group(function () {
        ...
        Route::put('/orders/{order}', [StaffOrderController::class, 'updateStatus'])->name('orders.update');
