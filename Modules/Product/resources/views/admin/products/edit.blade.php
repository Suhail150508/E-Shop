                    ...
                    <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2 mb-3">
                                @foreach($product->images as $image)
                                    <div class="position-relative">
                                        <img src="{{ $image->image_url }}" class="rounded border" style="width: 60px; height: 60px; object-fit: cover;">
                                    </div>
                                @endforeach
                            </div>
                        @endif
                        <div class="card border border-dashed bg-light text-center">
                            <div class="card-body py-3">
                                <i class="bi bi-images fs-2 text-muted mb-2"></i>
                                <div class="small text-muted mb-2">{{ __('Upload additional images') }}</div>
