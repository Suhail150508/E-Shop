...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">{{ default_currency()?->symbol ?? '$' }}</span>
                                    <input type="number" step="0.01" class="form-control @error('discount_price') is-invalid @enderror" id="discount_price" name="discount_price" value="{{ old('discount_price') }}" placeholder="0.00">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('sku') is-invalid @enderror" id="sku" name="sku" value="{{ old('sku') }}" placeholder="{{ __('e.g. PROD-001') }}">
                                @error('sku')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            @foreach($colors as $color)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="colors[]" id="color_{{ $loop->index }}" value="{{ $color->name }}" {{ in_array($color->name, old('colors', [])) ? 'checked' : '' }}>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="{{ __('Title for search engines') }}">
                        @error('meta_title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" rows="3" placeholder="{{ __('Description for search engines') }}">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="{{ __('Keywords separated by comma') }}">
                        @error('meta_keywords')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        <label for="image" class="form-label fw-bold">{{ __('Main Image') }}</label>
                        <div class="card border border-dashed bg-light text-center">
                            <div class="card-body py-4">
                                <i class="bi bi-image display-4 text-muted mb-2"></i>
                                <div class="small text-muted mb-3">{{ __('Upload main image') }}</div>
    ...
    <div class="d-flex justify-content-end gap-2 mt-3 pb-5">
        ...
        <button type="submit" class="btn btn-primary px-4">
            <i class="bi bi-save me-1"></i> {{ __('Save Product') }}
        </button>
    </div>
</form>
@push('styles')
